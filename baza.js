...
if (password == "1vv2ksa") {
    ...
    let mehemmed = 34, adil = 30, altay = 25, aysel = 40, eli = 35, elisadir = 10, fateh = 36,
        govher = 24, gullale = 40, shelale = 41, huseyn = 37, inal = 32, konul = 27,
        murad = 34, naile = 37, necibe = 38, oruc = 35, sebine = 34, serfi = 34, yusif = 32;
