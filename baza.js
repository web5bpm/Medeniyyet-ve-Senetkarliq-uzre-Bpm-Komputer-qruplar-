...
if (password == "1vv2ksa") {
    ...
    let mehemmed = 49, adil = 44, altay = 36, aysel = 63, eli = 53, elisadir = 16, fateh = 53,
        govher = 32, gullale = 65, shelale = 62, huseyn = 58, inal = 46, konul = 42,
        murad = 56, naile = 53, necibe = 58, oruc = 57, sebine = 42, serfi = 48, yusif = 39;
